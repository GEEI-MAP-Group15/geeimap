...
class AcademicLevelController extends AbstractController
{
    ...
    {
        return $this->render('admission/academic_level/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('academic_level_index');
        }

        return $this->render('admission/academic_level/new.html.twig', [
    ...
    {
        return $this->render('admission/academic_level/show.html.twig', [
            'academic_level' => $academicLevel,
        ]);
    }
    ...
    public function edit(Request $request, AcademicLevel $academicLevel): Response
    {
        ...
        return $this->render('admission/academic_level/edit.html.twig', [
            'academic_level' => $academicLevel,
            'form' => $form->createView(),
        ]);
    }
    ...
    /**
     * @Route("/{id}", name="academic_level_delete", methods={"DELETE"})
     */
