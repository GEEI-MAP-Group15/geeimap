...
class CollegeController extends AbstractController
{
    ...
    {
        return $this->render('admission/college/index.html.twig', [
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('admission/college/new.html.twig', [
            'college' => $college,
    ...
    {
        return $this->render('admission/college/show.html.twig', [
            'college' => $college,
        ]);
    }
    ...
    public function edit(Request $request, College $college): Response
    {
        ...
        return $this->render('admission/college/edit.html.twig', [
            'college' => $college,
            'form' => $form->createView(),
        ]);
    }
