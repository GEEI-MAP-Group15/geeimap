...
final class Version20200320112913 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE student (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, academicdata_id INT NOT NULL, application_id INT NOT NULL, background_id INT NOT NULL, name VARCHAR(255) NOT NULL, firstname VARCHAR(255) NOT NULL, date_of_birth DATE NOT NULL, home_address VARCHAR(255) NOT NULL, national_id_number INT NOT NULL, UNIQUE INDEX UNIQ_B723AF33A76ED395 (user_id), UNIQUE INDEX UNIQ_B723AF33253C38ED (academicdata_id), UNIQUE INDEX UNIQ_B723AF333E030ACD (application_id), UNIQUE INDEX UNIQ_B723AF33C93D69EA (background_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE academic_data ADD CONSTRAINT FK_312B6775AE77607C FOREIGN KEY (academiclevel_id) REFERENCES academic_level (id)');
        ...
        $this->addSql('ALTER TABLE student ADD CONSTRAINT FK_B723AF33C93D69EA FOREIGN KEY (background_id) REFERENCES background (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE academic_data DROP FOREIGN KEY FK_312B6775AE77607C');
        $this->addSql('ALTER TABLE student DROP FOREIGN KEY FK_B723AF333E030ACD');
        $this->addSql('ALTER TABLE student DROP FOREIGN KEY FK_B723AF33C93D69EA');
        ...
        $this->addSql('ALTER TABLE application DROP FOREIGN KEY FK_A45BDDC15B2086AD');
